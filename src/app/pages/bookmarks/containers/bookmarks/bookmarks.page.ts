...
import { BookmarksState } from 'src/app/pages/bookmarks/containers/state/bookmarks.reducer';
import { Bookmark } from 'src/app/shared/models/bookmark.model';
import { CityTypeaheadItem } from 'src/app/shared/models/city-typeahead-item.models';
import * as fromBookmarksSelectors from 'src/app/pages/bookmarks/containers/state/bookmarks.selectors';
import * as fromBookmarksActions from 'src/app/pages/bookmarks/containers/state/bookmarks.actions';
